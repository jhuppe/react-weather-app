...
let apiKey = '1f04a8280f41cffdf35eb5b1aed0d15a';
...
class App extends React.Component {
  ...
  getWeather = async (e) => {
    ...
    e.preventDefault();
    const api_call = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city},${country}&appid=${apiKey}&units=${units}`);
